...
[La Metodología RSM y el Primer Orden]{.parte-titulo}

## ¿Qué es la RSM? {.smaller}
...
## Estrategia Secuencial de la RSM {.smaller}
...
## El Modelo de Primer Orden {.smaller}
...
## Ascenso por Máxima Pendiente {.smaller}
...
[Modelos de Segundo Orden y Diseños RSM]{.parte-titulo}

## El Modelo de Segundo Orden {.smaller}
...
## Diseño Central Compuesto (CCD) {.smaller}
...
| **CCF** (caras centradas) | $\alpha = 1$ | Todos los puntos en el cubo $[-1,1]^k$ — útil cuando no se pueden alcanzar niveles extremos |

<br>

**Rotabilidad:** la calidad de predicción no depende de la dirección en el espacio de factores.

## Diseño de Box-Behnken (BBD) {.smaller}
...
[Análisis de la Superficie: Encontrando el Óptimo]{.parte-titulo}

## Punto Estacionario y Análisis Canónico {.smaller}
...
## Diagramas de Contorno y Superficie {.smaller}
...
## 🔵 Opcional: Optimización Múltiple {.smaller}
...
## 🔵 Opcional: Temas Avanzados {.smaller}
...
## Resumen Semana 4 {.smaller .center}
...
## Resumen del Curso DOE {.smaller .center}
